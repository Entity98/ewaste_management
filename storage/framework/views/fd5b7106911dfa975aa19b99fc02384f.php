                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="<?php echo e(route('product.details', ['slug'=>$products->slug])); ?>" title="<?php echo e($products->Name); ?>">
                                        <figure><img src="<?php echo e(asset('assets/images/products')); ?>/<?php echo e($products->image); ?>" 
                                            alt="<?php echo e($products->name); ?>"></figure>
                                    </a>
                                </div>
                                <div class="product-info">
                                    <a href="<?php echo e(route('product.details', ['slug'=>$products->slug])); ?>" class="product-name"><span><?php echo e($products->Name); ?></span></a>
                                    <div class="wrap-price"><span class="product-price"><?php echo e($products->regular_price); ?></span></div>
                                    <a href="#" class="btn add-to-cart" wire:click.prevent="store(<?php echo e($products->id); ?>, '<?php echo e($products->Name); ?>', <?php echo e($products->regular_price); ?>)">Add To Cart</a>
                                </div>
                            </div>
                        </li>
                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="widget-banner">
                            <figure><img src="<?php echo e(asset('assets/images/size-banner-widget.jpg')); ?>" width="270"
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="<?php echo e(route('product.details', ['slug'=>$p_product->slug])); ?>"
                                            title="<?php echo e($p_product->Name); ?>">
                                            <figure><img src="<?php echo e(asset('assets/images/products')); ?>/<?php echo e($p_product->image); ?>"
                                                    alt="<?php echo e($p_product->Name); ?>"></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
...
</main><?php /**PATH C:\Users\ijans\OneDrive\Desktop\laravel-10-shop-main\resources\views/livewire/search-component.blade.php ENDPATH**/ ?>