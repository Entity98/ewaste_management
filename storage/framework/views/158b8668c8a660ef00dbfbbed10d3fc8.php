...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favi-shop.png">
										...
										<?php if(Auth::user()->utype === 'ADM'): ?>
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="Categories" href="<?php echo e(route('admin.category')); ?>">Categories</a>
													</li>
													<li class="menu-item">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="<?php echo e(asset('assets/images/shop.png')); ?>" alt="mercado"></a>
						</div>

						<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('header-search-component')->html();
} elseif ($_instance->childHasBeenRendered('36oLbcA')) {
    $componentId = $_instance->getRenderedChildComponentId('36oLbcA');
    $componentTag = $_instance->getRenderedChildComponentTagName('36oLbcA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('36oLbcA');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('36oLbcA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Sitapaila, Kathmandu, Nepal</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">+977 - 123456789</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">infosec@ijansuwal.com.np</p>
											</li>											
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">+977 - 012345</b>
									</div>
								</div>
							</div>
					...
					<div class="container">
						<div class="back-link-box">
							...
							<div class="back-link-row">
								...
								<ul class="list-back-link" >
									<li><span class="row-title">Brands:</span></li>
									<li><a href="#" class="redirect-back-link" title="blackberry" >blackberry</a></li>
									<li><a href="#" class="redirect-back-link" title="samsung" >samsung</a></li>
									<li><a href="#" class="redirect-back-link" title="mi" >mi</a></li>
									...
									<li><a href="#" class="redirect-back-link" title="vivo Shoes" >vivo</a></li>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 SHOP'SHOP. All rights reserved</p>
					</div>
...
</html><?php /**PATH C:\Users\ijans\OneDrive\Desktop\laravel-10-shop-main\resources\views/layouts/base.blade.php ENDPATH**/ ?>